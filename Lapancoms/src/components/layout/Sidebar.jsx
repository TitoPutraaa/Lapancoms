      ...
      <div className="min-h-screen w-fit">
        ...
        >
          <button
            ...
            type="button"
            class={`text-dark hover:text-primary absolute top-2 right-3 inline-flex h-8 w-8 items-center justify-center bg-transparent text-sm lg:hidden`}
          >
            <svg
              class="h-3 w-3"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <ul className="space-y-2.5 font-medium">
              ...
              <li>
                <button
                  ...
                  className={`sideMenu text-dark group hover:bg-secondary flex w-full items-center rounded-lg p-2 ${
                    activeMenu === "dashboard" ? "active" : ""
                  }`}
                >
                  <svg
                    className="text-dark group-hover:text-secondary h-5 w-5 transition duration-75"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 22 21"
              ...
              <li>
                ...
                >
                  <svg
                    className="text-dark group-hover:text-secondary h-5 w-5 shrink-0 transition duration-75"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 18 21"
                ...
                <ul id="dropdown-example" className="hidden space-y-2 py-2">
                  <li>
                    <button
                      ...
                      className={`sideMenu text-dark group hover:bg-secondary flex w-full items-center rounded-lg p-2 pl-11 transition duration-75 ${
              ...
              <li>
                ...
                >
                  ...
                  <span className="group-hover:text-primary ms-3">Delete</span>
                </button>
              </li>
            </ul>
