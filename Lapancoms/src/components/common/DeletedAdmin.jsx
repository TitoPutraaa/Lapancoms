...
export default function DeletedAdmin({ view, setView, handleDelete, idDel }) {
  if (!view) return null;
      ...
      <div className="fixed inset-0 z-110 flex items-center justify-center bg-black/50">
        <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-xl">
          <div className="flex gap-4">
            ...
            <div className="">
              <h3 className="text-dark text-lg font-semibold">Delete Admin</h3>
              <p className="mt-1 text-sm text-gray-500">
                Are you sure you want to remove{" "}
                <span className="text-dark font-bold">{idDel.username}</span> ?
          ...
          <div className="mt-8 flex justify-end gap-3">
            ...
            <button
              onClick={() => handleDelete(idDel.idAdmin)}
              type="button"
